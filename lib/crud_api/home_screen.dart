  ...
  Future<void> fetchdata() async {
    ...
    if (response != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Failed to fetch employee list")));
    }
    setState(() {
      isLoading = false;
    });
...
// function for update employee
  ...
  Future<void> patchEmployeedata(
    ...
    if (response != null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Sccessfully Updated")));
      await fetchdata();
    } else {
      print(response);
      ScaffoldMessenger.of(context)
  ...
  Future<void> deleteEmployee({
    ...
    if (response != null) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text("Sccessfully deleted")));
      await fetchdata();
    } else {
      print(response);
      ScaffoldMessenger.of(context)
