...
class Home extends StatelessWidget {
 Home({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(appBar: AppBar(title: const Text("Data Passing")),
    body: Center(
      child:
      Column(
        children: [
         ElevatedButton(onPressed: (){
           Navigator.push(context, MaterialPageRoute(builder: (context)=>StateLessScreen(name:name,designation:designation,experience:experience)));
         }, child: const Text("TO Stateless Widget"),),
          ElevatedButton(onPressed: (){
      Navigator.push(context, MaterialPageRoute(builder: (context)=>StateFulscreen(name:name,designation:designation,experience:experience)));
    },
