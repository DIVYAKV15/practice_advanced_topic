...
import 'package:practice_advanced_topic/state_mgmt/provider_example/controllers/counter_controller.dart';
import 'package:provider/provider.dart';

void main() {
  runApp(MaterialApp(
    home: ChangeNotifierProvider(
        create: (context) => CounterProvider(), //is to check the changes
